...
$('#cv_pt').click(function () {
    window.open('/files//CV_SASTELVIO_SERAFIM_MANUEL_Versao27.01.2021_Europass_PT.pdf', '_blank');
});

$('#cv_en').click(function () {
    window.open('/files//CV_SASTELVIO_SERAFIM_MANUEL_Versao27.01.2021_Europass_EN.pdf', '_blank');
});
